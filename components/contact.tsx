...
import { Mail, Linkedin, Phone, ArrowRight, Twitter } from 'lucide-react'
...
export function Contact() {
  const channels = [
    ...
    },
    {
      ...
      label: 'Twitter',
      value: '@JenniferJoeMD',
      href: 'https://twitter.com/JenniferJoeMD',
  ...
  return (
    <section id="contact" className="py-16 sm:py-24 lg:py-32 px-4 sm:px-6 border-t border-border bg-linear-to-b from-background to-card/30">
            ...
            return (
              ...
              >
                <div className="relative bg-card/60 backdrop-blur border border-border rounded-lg sm:rounded-xl p-5 sm:p-6 lg:p-8 hover:border-accent/60 hover:bg-card transition-all duration-300 hover:shadow-lg sm:hover:shadow-xl hover:shadow-accent/20 h-full">
                  {/* Glow effect */}
                  <div className="absolute inset-0 bg-linear-to-br from-accent/10 to-transparent rounded-lg sm:rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
